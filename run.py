...
def main():
    ...
    if page == "Registration":
        st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://plus.unsplash.com/premium_photo-1671751033693-8b777c36b236?q=80&w=2012&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D");
