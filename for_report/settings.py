...
TOPIC_SCAN = 'scan'
TOPIC_VELO = 'cmd_vel'
TOPIC_ODOM = 'odom/ground_truth'

EPISODE_TIMEOUT_SECONDS     = 50    # Number of seconds after which episode timeout occurs
ARENA_LENGTH                = 40   # meters
ARENA_WIDTH                 = 40   # meters
SPEED_LINEAR_MAX            = 1.0  # m/s
SPEED_ANGULAR_MAX           = 1.5   # rad/s

LIDAR_DISTANCE_CAP          = 3.5   # meters
THRESHOLD_COLLISION         = 0.25  # meters
...
REAL_ARENA_LENGTH           = 42   # meters
REAL_ARENA_WIDTH            = 42   # meters
...
OBSERVE_STEPS   = 20000     # At training start random actions are taken for N steps for better exploration
STEP_TIME       = 0     # Delay between steps, can be set to 0
